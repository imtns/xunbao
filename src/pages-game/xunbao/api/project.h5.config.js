...
const WXCONFIG_URL = [
  'https://auth.vrupup.com/sanguo/auth/share.php?appid=wx7c3ed56f7f792d84&type=js', //[0：云聚客]
...
const PROJECT_CONFIG = {
  ...
  getUserInfo: {
    ...
    get_data_list: ['openid', 'iclubUserToken3', 'nickname', 'avatar'], //从本地缓存或者url中获取的字段名列表(当type为1时生效)
...
export { ERR_Ok, ERR_NO, ASSETS_URL, WXCONFIG_URL, WXCONFIG_SCRIPT_URL, REQUEST_URL, REQUEST_PROXY_URL, PROJECT_CONFIG_CODE, AUTH_URL, GET_USER_INFO_URL, PROJECT_CONFIG, SHARECONFIG, SECRETKEY }
