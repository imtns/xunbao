...
export default {
	...
	//获取oss上传参数
	getOssOptions: (data, url =
		'https://iclub/api.vrupup.com/sanguo/wujinwen/applet/test/public/index.php/iclub/api/oss_upload') => {
		return myRequest({
				type: 1
			},
			url,
	...
	getAddressDetail: (data, url =
		`/iclub/api/userReceiveAddress/get/${data}`) => {
