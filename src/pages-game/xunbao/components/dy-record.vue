    ...
    <u-popup :show="showRecord" mode="center" :safeAreaInsetBottom="false" bgColor="transparent" @close="close" :overlayOpacity="0.8" :closeOnClickOverlay="closeOnClickOverlay">
      <view class="tanctow flex-cen-col">
        ...
        <view class="" :style="{ opacity: endRecordShow ? '1' : '0' }">
          <u-image :src="`${ASSETSURL}tan2_2.png`" @touchstart="startRecord" @touchend="endRecord" width="233rpx" height="233rpx"></u-image>
        </view>
        <!-- 	<view class="" v-else>
						123
					</view> -->
...
import ossUploadFile from '@/pages-game/xunbao/js/oss-upload-file.js'
...
export default {
  ...
  methods: {
    ...
    setResultText(result) {
      ...
      tool
        .uploadFiles([that.voicePath], 'https://java.vrupup.com/identify/link/uploadFile')
        .then((res) => {
