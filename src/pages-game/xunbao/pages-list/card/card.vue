<template>
  <view class="card">
    <view class="cardceng" style="height: 100%">
      <view class="" style="padding-top: 20rpx; box-sizing: border-box">
        <view class="card1 oh">
          ...
          <view class="card11 le">
            ...
            <view class="imgImg">
              ...
              <image class="img" style="margin-left: -6rpx" :src="`${ASSETSURL}img/${compositionCount[1]}.png`"> </image>
              <image class="img" v-if="compositionCount[2]" style="margin-left: -12rpx" :src="`${ASSETSURL}img/${compositionCount[2]}.png`"></image>
            </view>
          </view>
        ...
        <view class="card2 oh" v-if="!bgGxShowFect">
          ...
          <view class="card22 le">
            ...
            <u-swiper radius="16" bgColor="transparent" imgMode="aspectFit" :autoplay="false" :current="current" keyName="img" :list="list" height="337" style="width: 100%" @change="swiper">
            </u-swiper>
          </view>
        ...
        <view class="card3" v-if="!bgGxShowFect">
          <view class="card31 tc" v-if="list[0].num == 0 && list[1].num == 0 && list[2].num == 0 && list[3].num == 0" @click="compound1_sq">
            <image :src="`${ASSETSURL}card/card51.png`"></image>
          </view>
          <view class="card31 tc" v-else-if="list[0].num > 0 && list[1].num > 0 && list[2].num > 0 && list[3].num > 0" @click="$u.throttle(compound, 2000)">
      ...
      <view class="card4">
        <view class="card4ceng oh">
          ...
          <view class="card41 le" v-for="(item, index) in list" :key="index" @click="dq_src_sq(index, item.num)">
            <view class="card411">
    ...
    <view style="margin-top: -100rpx">
      <shareAndDrop v-if="shareAndDropShow" :addressDate="addressDate" :show="shareAndDropShow" @close="shareAndDropShow = false" @selectAddress="selectAddress" @saveAddressInfo2="saveAddressInfo2" />
    </view>
    <!-- 获取奖品弹窗 -->
