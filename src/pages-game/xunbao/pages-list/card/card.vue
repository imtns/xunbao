	...
	<view class="card">
		...
		<u-popup :show="show" mode="center" @close="show = false" :overlayOpacity="0.8">
			...
			<view class="compound_ceng" v-show="compound1 == 3">
				<view class="compound1" @longpress="longpressSaveImg">
					<view class="compound11 tc">
						...
						<view class="compound11ffect" style="width: 474rpx; height: 702rpx; z-index: 11"
							v-show="dq_src == '2'">
							<card-flip ref="showfect2" :option="starList3"></card-flip>
						</view>
						<view class="compound11ffect" style="width: 474rpx; height: 702rpx; z-index: 11"
							v-show="dq_src == '0'">
							<card-flip ref="showfect0" :option="starList1"></card-flip>
						</view>
						<view class="compound11ffect" style="width: 474rpx; height: 702rpx; z-index: 11"
							v-show="dq_src == '1'">
							<card-flip ref="showfect1" :option="starList2"></card-flip>
						</view>
						<view class="compound11ffect" style="width: 474rpx; height: 702rpx; z-index: 11"
							v-show="dq_src == '3'">
	...
	export default {
		...
		methods: {
			...
			longpressSaveImg() {
				...
				console.log('长按保存图片', this[`starList${this.dq_src + 1}`].imgList[1])
				util.saveImageToPhotosAlbum(this[`starList${this.dq_src + 1}`].imgList[1])
			},
			//奖品弹窗回调——我再想一想
			closePrizePup() {
