      ...
      <view class="" style="padding-top: 20rpx; box-sizing: border-box">
        ...
        <view class="card2 oh">
          ...
          <view class="card22 le">
            ...
            <u-swiper bgColor="transparent" imgMode="aspectFit" :autoplay="false" :current="current" :list="list3" height="337" style="width: 100%" @change="swiper"> </u-swiper>
          </view>
        ...
        <view class="card3">
          <view class="card31 tc" v-if="list[0].id == 0 && list[1].id == 0 && list[2].id == 0 && list[3].id == 0" @click="compound1_sq">
            <image :src="`${ASSETSURL}card/card51.png`"></image>
          </view>
          <view class="card31 tc" v-else-if="list[0].hqu > 0 && list[1].hqu > 0 && list[2].hqu > 0 && list[3].hqu > 0" @click="compound">
...
export default {
  ...
  data() {
    return {
      ...
      list3: ['https://cdn.vrupup.com/s/116/ka_1.png', 'https://cdn.vrupup.com/s/116/ka_2.png', 'https://cdn.vrupup.com/s/116/ka_4.png', 'https://cdn.vrupup.com/s/116/ka_3.png'],
      starList: {
