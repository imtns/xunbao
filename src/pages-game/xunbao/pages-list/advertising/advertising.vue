<template>
  <view class="advertising">
    <view class="advertisingceng">
      ...
      <u-navbar @leftClick="fhui" class="custom-navbar" title="观看视频" fixed safeAreaInsetTop bgColor="#FFF" height="88rpx" placeholder></u-navbar>
      <view class="advertising1 oh" :class="'isUs' + dq_claas_i">
        <view class="advertising10 le">
          <u-line-progress :round="false" :showText="false" :percentage="percentage" inactiveColor="#CECECE" activeColor="#FA7700" :height="15"></u-line-progress>
      ...
      <view class="advertising2">
        <view class="advertising21">
          <video :src="video" :enable-progress-gesture="false" :controls="false" :autoplay="true" :muted="false" @pause="pause" @ended="ended" @timeupdate="timeupdate"></video>
        </view>
      ...
      <u-popup :show="showPyq" mode="center">
        <view class="pyq-pop pof haze" @click="openPyqPupup">
          <image :src="`${ASSETSURL}img/zhiYing.png`" style="position: absolute; top: 200rpx; right: 120rpx; width: 480rpx" mode="widthFix"></image>
        </view>
      </u-popup>
    </view>
