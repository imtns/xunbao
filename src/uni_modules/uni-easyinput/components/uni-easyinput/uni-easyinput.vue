<template>
  <view class="uni-easyinput" :class="{ 'uni-easyinput-error': msg, readonly }" :style="boxStyle">
    <view class="uni-easyinput__content" :class="inputContentClass" :style="inputContentStyle">
      ...
      <textarea
        ...
        @focus="_Focus"
        @confirm="onConfirm"
        @linechange="(e) => $emit('line-change', e)"
...
export default {
  ...
  computed: {
    ...
    inputContentStyle() {
      ...
      const borderColor = this.inputBorder && this.msg ? '#eee' : focusColor
      return obj2strStyle({
        'border-color': borderColor || '#eee',
