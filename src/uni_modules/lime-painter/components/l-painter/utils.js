...
const createFile = ({ fs, url, target, name }) => {
  return new Promise((resolve, reject) => {
    plus.io.resolveLocalFileSystemURL(
      url,
      (res1) => {
    ...
    plus.io.requestFileSystem(
      ...
      async (fs) => {
        try {
          ...
          let urls = ['https://gitee.com/dcloud/uni-app/raw/dev/dist/', 'https://static-6d65bd90-8508-4d6c-abbc-a4ef5c8e49e7.bspapp.com/lime-painter/']
