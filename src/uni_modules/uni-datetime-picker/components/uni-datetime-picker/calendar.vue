  ...
  <view class="uni-calendar" @mouseleave="leaveCale">
    ...
    <view v-if="insert || show" class="uni-calendar__content" :class="{ 'uni-calendar--fixed': !insert, 'uni-calendar--ani-show': aniMaskShow, 'uni-calendar__content-mobile': aniMaskShow }">
      ...
      <view v-if="!insert && !range && typeHasTime" class="uni-date-changed uni-calendar--fixed-top" style="padding: 0 80px">
        ...
        <time-picker type="time" :start="reactStartTime" :end="reactEndTime" v-model="time" :disabled="!tempSingleDate" :border="false" :hide-second="hideSecond" class="time-picker-style">
        </time-picker>
      </view>
      ...
      <view v-if="!insert && range && typeHasTime" class="uni-date-changed uni-calendar--fixed-top">
        ...
        <view class="uni-date-changed--time-end">
          ...
          <time-picker type="time" :end="reactEndTime" v-model="timeRange.endTime" :border="false" :hide-second="hideSecond" :disabled="!tempRange.after" class="time-picker-style"> </time-picker>
        </view>
      </view>
...
export default {
  ...
  methods: {
    ...
    choiceDate(weeks) {
      ...
      console.log('GGGGGGG', this.tempRange)
      this.change()
    },
    /**
     * 回到今天
