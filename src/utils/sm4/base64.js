      ...
      '/': [
        function (a, b, c) {
          ...
          function f(a) {
            ...
            for (c = 0; c < n; c += 4)
              (b = (l[a.charCodeAt(c)] << 18) | (l[a.charCodeAt(c + 1)] << 12) | (l[a.charCodeAt(c + 2)] << 6) | l[a.charCodeAt(c + 3)]),
                ...
                (j[k++] = 255 & b)
            return (
              2 === h && ((b = (l[a.charCodeAt(c)] << 2) | (l[a.charCodeAt(c + 1)] >> 4)), (j[k++] = 255 & b)),
              1 === h && ((b = (l[a.charCodeAt(c)] << 10) | (l[a.charCodeAt(c + 1)] << 4) | (l[a.charCodeAt(c + 2)] >> 2)), (j[k++] = 255 & (b >> 8)), (j[k++] = 255 & b)),
              j
            )
          }
          function g(a) {
          ...
          function j(a) {
            ...
            return (
              1 === d ? ((b = a[c - 1]), e.push(k[b >> 2] + k[63 & (b << 4)] + '==')) : 2 === d && ((b = (a[c - 2] << 8) + a[c - 1]), e.push(k[b >> 10] + k[63 & (b >> 4)] + k[63 & (b << 2)] + '=')),
              e.join('')
            )
          }
